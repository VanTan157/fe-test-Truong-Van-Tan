...
function DashboardPage() {
    ...
    const completionPercent = stats.total === 0 ? 0 : Math.round((stats.done / stats.total) * 100);
    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-gray-500 dark:text-gray-400">Task management overview</p>
            </div>
                ...
                <Table
                    ...
                    columns={[
...

                        {
                            ...
                            render: (priority: TaskPriority) => <PriorityTag priority={priority} />,
                        },
